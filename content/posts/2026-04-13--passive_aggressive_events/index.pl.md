...
I already warned you in past [not to let Event-Driven Architecture buzzwords fool us](/pl/dont_let_event_driven_architecture_buzzwords_fool_you/).
...
How to find such cases? [Doing Example Mapping during modelling can be a good option for that](/pl/intro_to_example_mapping/).
