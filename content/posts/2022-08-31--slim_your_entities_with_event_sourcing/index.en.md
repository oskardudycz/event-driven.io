...
Let's say that we're modelling the shopping cart aggregate known from [the previous post](/en/introduction_to_event_sourcing/). We have the following requirements:
