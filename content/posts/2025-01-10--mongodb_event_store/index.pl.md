---
title: Building MongoDB event store
...
**I have always said that is not the best choice for event storage, and guess what?** I just released the stable version of the MongoDB event store in Emmett. 
...
**I was lucky to have such with [Alexander Lay-Calvert](https://github.com/alex-laycalvert).** He did most of the hard work; I was helping conceptually and with final touches. So, what you read today is a summary of our conjoined effort with a majority made by Alex.
...
Read more about that in [Event Streaming is not Event Sourcing!](/pl/event_streaming_is_not_event_sourcing/).
