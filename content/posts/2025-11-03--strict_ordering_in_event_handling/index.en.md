...
- You can have different scaling capabilities for internal and external events. Maybe for internal, you don't even need a messaging system, maybe [outbox or event store subscriptions](/en/outbox_inbox_patterns_and_delivery_guarantees_explained/) will be enough? Maybe you could cut costs using AWS SQS for internal communication and AWS Kinesis for cross-module?
