...
Therefore, it may turn out that the OrderConfirmed event in such an amassed form will have redundant data. [Adding GDPR into the equation makes things more challenging](/en/gdpr_for_busy_developers). We might not want to send all data everywhere. Therefore, instead of one event, you can publish three: 
