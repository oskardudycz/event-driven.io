...
I’m also to blame; I’m falling into precisely the same trap too often. Like recently, while working on [Strictland, the contract testing library I announced in the previous article](/pl/announcing-strictland-contract-testing).
...
It’s also aligned with my motto: [Removability over Maintainability](/pl/removability_over_maintainability/).
