...
Recently, I realised during [my workshops](/pl/training/) that referencing Friends is not so cool anymore. It started to happen when I was explaining the Example Mapping technique.
...
What's more, if you look at the Given/When/Then pattern, you may notice that it works nicely with Behaviour-Driven Design. I already wrote that [Behaviour-Driven Design is more than tests](/pl/behaviour_driven_design_is_not_about_tests/). How to do it? Check [here](/pl/testing_event_sourcing_emmett_edition/). 
...
[Most of the teams I'm working with](/pl/training/) are enjoying this technique, as it's a fun way to get quick, actionable outcomes.
