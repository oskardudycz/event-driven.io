...
For Java version check the [follow-up article showing how to do make it generic using a custom streams collector](/en/how_to_write_left_fold_collector_in_java)
