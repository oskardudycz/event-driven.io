...
- [business rules or](/en/dealing_with_race_conditions_in_eda_using_read_models/),
- [detecting the gap between the last processed revision and the event revision](/en/strict_ordering_in_event_handling/).

![queue5](./queue5.png)

We can also apply techniques like the [_Phantom record_](/en/dealing_with_race_conditions_in_eda_using_read_models/), where we keep data as it comes and take the next steps only when defined conditions are met. And that's also what I'd recommend in general, but...
