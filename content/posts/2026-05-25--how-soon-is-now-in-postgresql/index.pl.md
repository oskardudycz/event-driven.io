...
Read also:
- [Rebuilding Event-Driven Read Models in a safe and resilient way](/pl/rebuilding_read_models_safely/), with the locking design this bug lives inside,
